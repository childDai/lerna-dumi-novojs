"use strict";(self.webpackChunknovojs_kit=self.webpackChunknovojs_kit||[]).push([[5500],{95500:function(a,e,n){n.r(e),n.d(e,{default:function(){return t}});var t=[Object.freeze({displayName:"Vyper",name:"vyper",patterns:[{include:"#statement"},{include:"#expression"},{include:"#reserved-names-vyper"}],repository:{"annotated-parameter":{begin:`(?x)
\\b
([[:alpha:]_]\\w*) \\s* (:)
