"use strict";(self.webpackChunknovojs_kit=self.webpackChunknovojs_kit||[]).push([[1814],{91814:function(a,e,n){n.r(e),n.d(e,{default:function(){return t}});var t=[Object.freeze({displayName:"Mojo",name:"mojo",patterns:[{include:"#statement"},{include:"#expression"}],repository:{"annotated-parameter":{begin:`(?x)
\\b
([[:alpha:]_]\\w*) \\s* (:)
